"""
db_supabase — Supabase (PostgreSQL) data layer
...
from db_supabase.summary import (
    get_summary, get_date_summary, get_today_summary,
...
from db_supabase.prefs import (
    ...
    set_recurring_remind_day, get_recurring_remind_day, get_all_recurring_remind_users,
)
